...
public class BankService {
    ...
    /**
     * Метод идентифицирует пользователя по номеру пасспорта и при удаляет его из переменной
    ...
    /**
     * Метод идентифицирует пользователя по папорту и аккаунт по реквизиту, возращает аккаунт
